    ...
    <div className="min-h-screen bg-navy-950 pt-20">
      <div className="bg-gradient-to-b from-navy-900 to-navy-950 border-b border-white/10 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-slate-400 text-lg max-w-2xl mx-auto">Bridging the gap between local businesses and community organizations through meaningful, community-driven partnerships.</p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-20">
          <div>
            ...
            <div className="space-y-5 text-slate-400 leading-relaxed">
              <p>GS Advertising & Connections was founded with a singular vision: to create a professional, trusted platform where local businesses can meaningfully invest in the communities they serve, and where community programs can access the resources they need to thrive. We believe that the relationship between local commerce and community programs is one of the most powerful social contracts in American life — and we built this platform to nurture, formalize, and scale that relationship.</p>
              <p>Our mission goes beyond transactions. Every sponsorship facilitated through GS Advertising & Connections represents a business becoming part of a community story — a story told in uniforms, banners, event programs, and the memories of community members who grow up knowing that their community invested in them. We exist to make those connections possible, professional, and lasting.</p>
            </div>
          </div>
          <div>
            <img
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-20 items-center">
          ...
          <div>
            ...
            <div className="space-y-5 text-slate-400 leading-relaxed">
              <p>The challenges that led to GS Advertising & Connections are universal: community leaders running fundraiser after fundraiser just to afford basic equipment; local businesses spending advertising dollars on platforms with no connection to their actual community; members watching their programs miss opportunities because they couldn't afford tournament fees or proper uniforms. These are solvable problems — they just require the right bridge.</p>
              <p>We recognized that businesses want to support their communities — they simply lack a direct, professional channel to do so. And we saw organizations with incredible stories, dedicated athletes, and passionate leaders who just needed someone to notice them. GS Advertising & Connections is that bridge. We provide the infrastructure, the trust framework, and the marketplace that turns good intentions into real partnerships that benefit everyone involved.</p>
            </div>
          </div>
        </div>
        ...
        <div className="mb-20">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              { icon: Zap, title: 'Real Impact', desc: "We measure success by the tangible difference made in people's lives.", color: 'text-emerald-400', bg: 'bg-emerald-400/10', border: 'border-emerald-400/20' },
            ].map((v, i) => (
        ...
        <div className="text-center bg-gradient-to-br from-gold-500/10 to-transparent border border-gold-400/20 rounded-3xl p-12">
          ...
          <p className="text-slate-400 text-lg mb-8 max-w-2xl mx-auto">Whether you're a business ready to invest in your community or an organization looking for support, there's a place for you on GS Advertising & Connections.</p>
