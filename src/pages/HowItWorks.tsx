...
const STEPS_BUSINESS = [
  ...
  { title: 'Create Sponsorship Listings', desc: "Once active, create detailed sponsorship listings. Specify the sponsorship type (jersey, banner, event, etc.), the amount you're offering, what seekers receive in exchange, and any requirements.", tip: 'Businesses with multiple diverse listing types receive the most applications.' },
  { title: 'Review and Respond to Applications', desc: 'Sponsor seekers that are interested in your opportunity will apply directly through the platform. Review their profiles, descriptions, and reasons for applying, then accept, decline, or save their applications.', tip: 'Respond to applications promptly to build your reputation on the platform.' },
  { title: 'Build the Partnership', desc: "Once you've accepted an application, you'll have the contact information to coordinate the sponsorship details. This is where the real relationship begins.", tip: 'The most successful sponsors maintain the relationship beyond a single season.' },
];

const STEPS_TEAM = [
  { title: 'Create a Free Sponsor Seeker Account', desc: 'Sign up as a sponsor seeker — whether you\'re a sports team, organization, or individual. Fill in your profile with your name, category, location, and a compelling bio. This is your first impression to potential sponsors.', tip: "A detailed bio explaining your story dramatically increases acceptance rates." },
  { title: 'Browse the Marketplace', desc: "Explore active sponsorship opportunities from local businesses. Use filters to find the best matches for your needs.", tip: 'Filter by location to find businesses in your immediate community.' },
  ...
  { title: 'Submit Compelling Applications', desc: "When you're ready to apply, tell the business about your organization, why you need the sponsorship, how it will be used, and what they can expect in return. Be specific, sincere, and professional.", tip: 'Specific, genuine applications outperform generic ones every time.' },
  { title: 'Receive and Confirm Sponsorship', desc: "If a business accepts your application, you'll receive a notification. Reach out via the contact information provided and begin coordinating the details of your sponsorship agreement.", tip: 'Follow up with sponsors throughout the partnership to build lasting relationships.' },
];
    ...
    <div className="min-h-screen bg-navy-950 pt-20">
      <div className="bg-gradient-to-b from-navy-900 to-navy-950 border-b border-white/10 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-slate-400 text-lg max-w-2xl mx-auto">A step-by-step guide to connecting businesses with sponsor seekers on GS Advertising & Connections.</p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-20">
          {[
            ...
            { icon: Search, label: 'Seekers Browse & Apply', num: '03' },
        ...
        <div>
          <div className="flex items-center gap-3 mb-10">
            ...
            <div>
              <p className="text-gold-400 text-xs font-semibold uppercase tracking-wider">For Sponsor Seekers</p>
          ...
          <div className="mt-6 flex justify-center">
            <Link to="/register?type=team" className="inline-flex items-center gap-2 px-8 py-4 bg-gold-500 hover:bg-gold-400 text-navy-950 font-bold rounded-2xl transition-all">
              Register as Sponsor Seeker <ArrowRight size={18} />
            </Link>
          </div>
        </div>
      </div>
