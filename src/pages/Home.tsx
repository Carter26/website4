        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-20">
          <div className="max-w-4xl">
            ...
            <h1 className="text-5xl sm:text-6xl lg:text-7xl font-black text-white leading-tight mb-6">
              ...
              With Local Sponsor Seekers
            </h1>

            <p className="text-slate-300 text-xl sm:text-2xl leading-relaxed mb-10 max-w-3xl">
              Helping businesses grow community visibility while supporting teams, organizations, and community causes through meaningful, lasting sponsorships.
            </p>
            ...
            <div className="grid grid-cols-3 gap-8 max-w-xl">
              {[
                ...
                { label: 'Seekers', value: 'Nationwide' },
        ...
        <section className="py-24 bg-navy-900/50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-slate-400 text-lg max-w-2xl mx-auto">Three powerful pillars that make every sponsorship meaningful for both businesses and sponsor seekers.</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                },
                {
                  ...
                  description: "Every sponsorship through GS Advertising directly impacts communities. Sponsorship funds help teams and organizations purchase equipment, cover tournament fees, afford travel costs, and invest in uniforms that instill pride. When a business sponsors a team, they're not just buying advertising — they're investing in their community. The goodwill generated by sponsoring local programs creates lasting positive associations for your brand that money can't buy elsewhere."
                },
                {
                  icon: Handshake,
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <div className="space-y-6">
                  <p className="text-slate-300 text-lg leading-relaxed">
                    At GS Advertising & Connections, we believe that local businesses and community organizations are both pillars of strong communities — and that connecting them creates opportunities that benefit everyone. Our mission is to create a sustainable ecosystem where businesses gain meaningful local visibility, and community teams and organizations receive the financial support they need to thrive, compete, and grow.
                  </p>
                  <p className="text-slate-400 leading-relaxed">
                    We're dedicated to ensuring that every program has access to the resources they need to compete at their highest level. Every sponsorship on our platform represents more than just advertising — it represents a community investing in itself, a business becoming a genuine local institution, and a partnership that builds social capital that lasts for years. We're not just a platform; we're a movement to strengthen the bonds between local commerce and community causes.
                  </p>
                </div>
                <div className="mt-8 flex flex-wrap gap-4">
                  {['Community Impact', 'Local Growth', 'Community Impact', 'Lasting Bonds'].map(tag => (
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  { icon: Trophy, title: 'Community Programs', desc: 'Supported with resources and funding' },
                  { icon: Building2, title: 'Local Businesses', desc: 'Growing visibility through community investment' },
                  { icon: Users, title: 'Community Members', desc: 'Connected to businesses that share their values' },
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="order-1 lg:order-2">
                ...
                <div className="space-y-6">
                  <p className="text-slate-300 text-lg leading-relaxed">
                    GS Advertising & Connections was created out of a firsthand understanding of two persistent challenges: community teams and organizations perpetually struggling to find adequate sponsorship funding, and local businesses searching for advertising channels that actually reach their community. Traditional advertising — billboards, radio spots, digital banners — misses the authentic local connection that drives real customer loyalty. Meanwhile, talented programs miss opportunities because their teams lack basic resources.
                  </p>
                  <p className="text-slate-400 leading-relaxed">
                    We built this platform to eliminate these parallel struggles by creating a dedicated marketplace that connects businesses specifically seeking community visibility with teams and organizations specifically seeking community support. By bringing both sides together in one professional platform, we've created a streamlined environment where partnerships form quickly, relationships develop naturally, and both businesses and community programs achieve outcomes they couldn't reach alone. GS Advertising & Connections isn't just solving a business problem — it's building the infrastructure for stronger local communities everywhere.
                  </p>
                </div>
        ...
        <section className="py-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-slate-400 text-lg max-w-2xl mx-auto">Four simple steps to connect businesses with sponsor seekers and build lasting community partnerships.</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                ...
                { step: '03', icon: Users, title: 'Seekers Apply', desc: "Teams and organizations browse opportunities and apply with their story, showcasing why they're the perfect fit.", color: 'text-emerald-400', bg: 'bg-emerald-400/10', border: 'border-emerald-400/20' },
                { step: '04', icon: Handshake, title: 'Partnership Formed', desc: 'Businesses review applications, connect with seekers, and partnerships are finalized on both sides.', color: 'text-gold-400', bg: 'bg-gold-400/10', border: 'border-gold-400/20' },
              ].map((item, i) => (
          ...
          <section className="py-24">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-12">
                ...
                <p className="text-slate-400 text-lg max-w-2xl mx-auto">Our Premium Members are leading businesses committed to supporting local teams, organizations, and community growth.</p>
              </div>
        ...
        <section className="py-24 bg-navy-900/50">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-slate-400 text-xl mb-10">
              Whether you're a business looking to grow your community presence or an organization looking for support, GS Advertising & Connections has a place for you.
            </p>
